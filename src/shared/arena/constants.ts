...
export const BUILTIN_GAME_MODES: GameMode[] = [
  ...
  },
  {
    ...
    setupSummary: '多轮圆桌发言，按席位轮流讨论议题。无身份隐藏、无投票、无产物输出。',
    ruleHighlights: [
      '开局前设定议题与发言轮数。',
      '可选 AI 主持人引导流程。',
      '保持角色人设，回应他人观点。',
    ...
    phases: [
      { id: 'opening', name: '开场', kind: 'action', order: 1, description: '主持人介绍议题（可选）。' },
      { id: 'round-discuss', name: '圆桌发言', kind: 'discussion', order: 2, description: '按席位轮流发言，多轮进行。' },
      { id: 'closing', name: '结束', kind: 'result', order: 3, description: '讨论结束。' },
    ],
  },
  {
    ...
    speechDisplay: DEFAULT_ROUNDTABLE_SPEECH_DISPLAY,
    setupSummary: '发散讨论玩法流程与开局配置，最后由解说归纳玩法产物（规则要点清单）。',
    ruleHighlights: [
      '聚焦可执行的规则与阶段设计。',
      '可质疑现有流程，须给出替代方案。',
      '结束时输出结构化玩法草案。',
  ...
  },
  {
    ...
    engineKind: 'brainstorm',
    speechDisplay: DEFAULT_ROUNDTABLE_SPEECH_DISPLAY,
    setupSummary: '围绕角色塑造发散讨论，最后归纳人设产物（原则、口癖、禁忌等）。',
    ruleHighlights: [
      '从可识别行为出发，而非空泛形容词。',
      '可提出具体台词或原则草案。',
      '结束时输出结构化角色塑造清单。',
