  ...
  },
  {
    ...
    templates: [
      ...
      tpl(
        ...
        'match_recap',
        '讨论产物归纳',
        '你是讨论记录员。根据讨论材料输出 JSON：{"title":"讨论纪要标题","summary":"180字内总结","sections":[{"heading":"共识/分歧/亮点","bullets":["要点"]}],"openQuestions":["待继续探讨的问题"],"artifact":"可选：一行结构化摘要"}',
        '讨论材料：\n{{matchSummary}}',
        'json'
      ),
      tpl(
  ...
  },
  {
    ...
    templates: [
      ...
      tpl(
        ...
        'match_recap',
        '产物归纳',
        '你是玩法设计头脑风暴的记录员。根据讨论材料输出 JSON：{"title":"玩法草案标题","summary":"180字内总结","sections":[{"heading":"规则要点","bullets":["要点"]}],"openQuestions":["待验证假设"],"artifact":"结构化玩法草案：阶段/人数/信息公开/胜负/开局配置清单"}',
        '讨论材料：\n{{matchSummary}}',
        'json'
      ),
    ],
  },
  {
    ...
    templates: [
      ...
      tpl(
        ...
        'match_recap',
        '产物归纳',
        '你是角色塑造头脑风暴的记录员。输出 JSON：{"title":"角色清单标题","summary":"180字内总结","sections":[{"heading":"塑造要点","bullets":["要点"]}],"openQuestions":["待细化问题"],"artifact":"结构化角色清单：定位/口癖/原则/禁忌/示例台词"}',
        '讨论材料：\n{{matchSummary}}',
        'json'
      ),
    ],
...
export const BUILTIN_GAME_SCENARIOS: GameScenarioDefinition[] = [
  ...
  },
  {
    ...
    name: '圆桌讨论',
    subtitle: '议题讨论',
    description: '围绕议题进行多轮发言，倾听与回应。玩家担任裁判引导轮次，结束时产出讨论纪要。',
